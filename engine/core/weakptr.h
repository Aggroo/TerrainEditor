...
{
    _assert2(this->ptr, "NULL pointer access in WeakPtr::operator->()!");
    return this->ptr;
}
...
{
    _assert2(this->ptr, "NULL pointer access in WeakPtr::operator TYPE*()!");
    return this->ptr;
}
...
{
    _assert2(this->ptr, "NULL pointer access in WeakPtr::get()!");
    return this->ptr;
}
